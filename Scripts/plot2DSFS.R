...
colv<-rainbow(n=40,start=0, end =0.28)
...
#image(x=seq(0,n1), y=seq(0,n2), col=colv, z=-log10(values), xlab=pop1, ylab=pop2, main="Joint SFS")
image(x = seq(0,1,length.out = nrow(ANGSD.2D.SFS)), y = seq(0,1,length.out=ncol(ANGSD.2D.SFS)), col=colv, z=ANGSD.2D.SFS, xlab=pop1, ylab=pop2, main="Joint SFS")
